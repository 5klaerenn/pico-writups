...
Play this short game to get familiar with terminal applications
and some of the most important rules in scope for picoCTF.

## Writeup

flag: picoCTF{m1113n1um_3d1710n_dd015572}

En lancant le serveur, on arrive sur le texte suivant :
...
Je choisir l'option c. C'est encore du texte : 
